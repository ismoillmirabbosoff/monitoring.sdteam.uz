...
const M = {
  uz: {
    ...
    'nav.dashboard': 'Boshqaruv paneli', 'nav.survey': 'Anketa', 'nav.surveyReport': 'Anketa hisoboti',
    'nav.servers': 'Serverlar', 'nav.staff': 'Hodimlar', 'nav.sessions': 'Sessiyalar', 'nav.tv': 'TV ekran',
    ...
    'tv.unfilled': "To'ldirilmagan anketa", 'tv.servers': 'Serverlar',
  },
  ru: {
    'app.subtitle': 'Колл-центр',
    'nav.dashboard': 'Панель', 'nav.survey': 'Анкета', 'nav.surveyReport': 'Отчёт по анкетам',
    'nav.servers': 'Серверы', 'nav.staff': 'Сотрудники', 'nav.sessions': 'Сессии', 'nav.tv': 'ТВ экран',
    ...
    'tv.unfilled': 'Незаполненные анкеты', 'tv.servers': 'Серверы',
  },
  en: {
    'app.subtitle': 'Call Center',
    'nav.dashboard': 'Dashboard', 'nav.survey': 'Survey', 'nav.surveyReport': 'Survey report',
    'nav.servers': 'Servers', 'nav.staff': 'Staff', 'nav.sessions': 'Sessions', 'nav.tv': 'TV screen',
    ...
    'tv.unfilled': 'Unfilled surveys', 'tv.servers': 'Servers',
  },
}
